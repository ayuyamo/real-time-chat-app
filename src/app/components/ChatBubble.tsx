    ...
    return (
        <div className='flex items-start gap-2.5'>
            ...
            <div className='flex flex-col gap-1 w-full max-w-[320px]'>
                ...
                {/* Message */}
                <div className='inline-flex flex-col leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700' style={{ width: 'fit-content' }}>
    ...
    return (
        <div className='flex items-start gap-2.5 justify-end'>
            ...
            <div className='flex flex-col gap-1 w-full max-w-[320px] items-end'>
                ...
                <div className='flex flex-col leading-1.5 p-4 border-gray-200 bg-blue-400 text-white rounded-tl-xl rounded-bl-xl rounded-br-xl' style={{ width: 'fit-content' }}>
